...
There should be test of the Web service in a file prefixed `test_`
...
- Command-line interface
  - "Natural language processing - Appendix A 
- Git
  - "Natural language processing - Appendix B
...
- Web serving with FastAPI
  - "Natural language processing" - chapter 8.1 "Web serving"
- Docker
  - "Natural language processsing - section 8.2 "Containerization"
- Sentiment analysis
  - "Natural language processing" - chapter 11 "Sentiment analysis"
